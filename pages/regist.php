...
<body>
    ...
    <div class="container regist-container">
        ...
        <div class="regist-form-content">
            <h1 class="regist-title">Já tem conta?<a href="login.php">Faça login</a></h1>
            ...
            <form action="../actions/processa_user.php" method="POST" class="regist-form" id="registForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome"
                           placeholder="O teu nome completo" minlength="3" maxlength="120" aria-label="Full Name" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email"
                           placeholder="seu.email@exemplo.com" aria-label = "Email Adress" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="password-input-wrapper">
                        <input type="password" class="form-control" id="password" name="password_hash"
                               placeholder="••••••••" minlength="8" aria-label = "Password" required>
                        <button type="button" class="btn-toggle-password" onclick="togglePassword('password')" aria-label="Ver password">
                ...
                <div class="mb-3">
                    ...
                    <div class="password-input-wrapper">
                        <input type="password" class="form-control" id="confirm_password" name="confirm_password"
                               placeholder="••••••••" minlength="8" aria-label = "Confirm Password" required>
                        <button type="button" class="btn-toggle-password" onclick="togglePassword('confirm_password')" aria-label="Ver verificação password">
                            <i class="bi bi-eye-fill"></i>
                        </button>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="telefone" name="telefone"
                           placeholder="913 047 889" aria-label = "Phone Number" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="data_nascimento" name = "data_nascimento" aria-label = "Date of Birth">
                </div>

                <button type="submit" class="btn btn-primary regist-button" aria-label = "Register button">
