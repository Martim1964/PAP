        ...
        <div class="regist-form-content">
            ...
            <div class="mb-3">
                <label for="nome" class="form-label">
                    <i class="bi bi-person-fill"></i> Nome de Utilizador
                </label>
                <input type="text" class="form-control" id="username" name="nome" placeholder="Escolha um nome de utilizador" minlength="3" maxlength="50" required>
            ...
            <div class="mb-3">
                ...
                <div class="password-input-wrapper">
                    <input type="password" class="form-control" id="password" name="password_hash" placeholder="••••••••" minlength="8" required>
            ...
            <div class="mb-3">
                ...
                <div class="password-input-wrapper">
                    <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="••••••••" minlength="8" required>
            ...
            <div class="mb-3">
                ...
                <input type="telefone" class="form-control" id="telefone" name="telefone" placeholder="913047889" required>
