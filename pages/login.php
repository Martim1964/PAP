            ...
            <div class="login-form-section">
                <form action="../actions/processa_login.php" method="POST" class="login-form" id="loginForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="seu.email@exemplo.com" aria-describedby="email-help" required autocomplete="email">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-input-wrapper">
                            <input type="password" class="form-control" id="password" name="pass" placeholder="••••••••" aria-describedby="password-help" required autocomplete="current-password">
