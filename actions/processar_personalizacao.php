...
<?php
    ...
    // Insere na BD independentemente de ter foto ou não
    $fileName = null;

    if (!empty($_FILES['photo']['name'])) { // Só trata a foto se ela existir
        $fileName = $_FILES["photo"]["name"];
        $path = __DIR__ . '/../img-pap/upload-bolos-personalizados/' . $fileName;
